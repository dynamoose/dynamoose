      ...
      it('Create complex model with unnamed attributes', function (done) {
        ...
        describe('Model.update', function (){
          ...
          it("Update model using timestamp field 'createdAt' as rangeKey", function () {
            return Cats.Cat12.create({name: 'Fluffy', age: 1}, {overwrite: true}).then(function (old) {
              return Cats.Cat12.update({name: old.name, createdAt: old.createdAt}, {age: 2}).then(function(data) {
