...
import {AnyItem, AnyItemMethods, Item, ItemMethods} from "../../Item";
import {Model} from "../../Model";

export default <T extends Item = AnyItem, U extends ItemMethods = AnyItemMethods>(model: Model<T>): ModelType<T, U> => {
