...
Table.prototype.init = function(next) {
  ...
  if (this.options.create) {
    ...
    .then(function (data) {
      ...
      if(data.TableStatus !== 'ACTIVE' && table.options.waitForActive){
        return deferred.resolve(table.waitForActive());
      }
...
Table.prototype.waitForActive = function(next) {
  debug('waiting for Activ table', this);
  var deferred = Q.defer();
  ...
  deferred.resolve(waitForActive());
