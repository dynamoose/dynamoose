...
Schema.prototype.getAttributeSettingValue = function(setting, key: string, settings: any = {}): any {
...
Schema.prototype.getAttributeType = function(key: string, value?: ValueType, settings?: any): string {
	try {
