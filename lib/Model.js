...
Model.update = function(NewModel, key, update, options, next) {
  ...
  if (options.updateExpires && schema.expires) {
    var expiresLabel = schema.expires.attribute;
    var expiresAttribute = schema.attributes[expiresLabel];
    var expiresDefaultValue = expiresAttribute.options.default();
