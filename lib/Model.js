...
Model.prototype.populate = function (options, resultObj, fillPath) {
  ...
  var modelPropName = Object.keys(this.$__.table.base.models).filter(function(key){
    return this.$__.table.base.models[key].$__.name === this.$__.table.base.models[key].$__.options.prefix + options.model || this.$__.table.base.models[key].$__.name === options.model;
  }.bind(this)).pop();

  var Model = this.$__.table.base.models[modelPropName];
