...
function Schema(obj, options) {
  ...
  if (this.options.timestamps) {
    ...
    obj[createdAt].type = timestampType;
    obj[createdAt].default = timestampDefaultFunciton;


    obj[updatedAt] = obj[updatedAt] || {};
    obj[updatedAt].type = timestampType;
    obj[updatedAt].default = timestampDefaultFunciton;
    obj[updatedAt].set = timestampDefaultFunciton;
