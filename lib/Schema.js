...
function Schema(obj, options) {
  ...
  this.useDocumentTypes = typeof this.options.useDocumentTypes === 'undefined' ? true : !!this.options.useDocumentTypes;
  this.useNativeBooleans = typeof this.options.useNativeBooleans === 'undefined' ? true : !!this.options.useNativeBooleans;
