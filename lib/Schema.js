  ...
  if (this.options.timestamps) {
    ...
    if (this.options.timestamps === true) {
      ...
      if (this.options.timestamps.createdAt && this.options.timestamps.updatedAt) {
    		if (typeof this.options.timestamps.createdAt === "string") {
    			createdAt = this.options.timestamps.createdAt;
    		} else if (typeof this.options.timestamps.createdAt === "object") {
          createdAt = this.options.timestamps.createdAt.name;
    		} else {
          throw new errors.SchemaError('Invalid syntax for timestamp: ' + this.options.timestamps);
        }

    		if (typeof this.options.timestamps.updatedAt === "string") {
    			updatedAt = this.options.timestamps.updatedAt;
    		} else if (typeof this.options.timestamps.updatedAt === "object") {
          updatedAt = this.options.timestamps.updatedAt.name;
    		} else {
          throw new errors.SchemaError('Invalid syntax for timestamp: ' + this.options.timestamps);
        }
      } else {
    ...
    if (typeof this.options.timestamps === 'object' && this.options.timestamps.createdAt && this.options.timestamps.createdAt.rangeKey === true) {
      obj[createdAt].rangeKey = true;
    }
    ...
    if (typeof this.options.timestamps === 'object' && this.options.timestamps.updatedAt && this.options.timestamps.updatedAt.rangeKey === true) {
      obj[updatedAt].rangeKey = true;
    }
