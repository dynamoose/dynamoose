...
function Schema(obj, options) {
  ...
  if (this.options.timestamps) {
    var createdAt = null;
    var updatedAt = null;
    var timestampDefaultFunciton = Date.now;
    var timestampType = Date;
    ...
    if (this.options.timestamps === true) {
      ...
      if (this.options.timestamps.createdAt && this.options.timestamps.updatedAt) {
        ...
        if (this.options.timestamps.default) {
          timestampDefaultFunciton = this.options.timestamps.default;
        }
        if (this.options.timestamps.type) {
          timestampType = this.options.timestamps.type;
        }
      } else {
    ...
    obj[createdAt].type = obj[createdAt].type || timestampType;
    obj[createdAt].default = obj[createdAt].default || timestampDefaultFunciton;


    obj[updatedAt] = obj[updatedAt] || {};
    obj[updatedAt].type = obj[updatedAt].type || timestampType;
    obj[updatedAt].default = obj[updatedAt].default || timestampDefaultFunciton;
    obj[updatedAt].set = obj[updatedAt].set || timestampDefaultFunciton;
