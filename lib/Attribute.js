...
// This function takes in a `value` as a parameter and sets the type of this attribute based on the type of that value.
// No type defined - assume this is not a type definition and we must grab type directly from value.
// Examples of `value` parameters that might be passed in:
// { type: [Function: String], required: true, default: 'Mittens' }
// function String() { [native code] }
// { type: [Function: Number], validate: [Function: validate], default: 888 }
// 1
// false
// "puddles"
// [ 'cute', 'fuzzy' ]
