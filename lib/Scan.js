...
function ScanCarrier(model) {
	...
	Scan.prototype.getScanRequest = function() {
		...
		if (this.settings.startAt) {
			object.ExclusiveStartKey = model.Document.toDynamo(this.settings.startAt); // TODO: I don't think this will work if the user passes in a DynamoDB object
		}
