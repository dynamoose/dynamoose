...
| --- | --- | --- | --- |
| [`v3`](https://github.com/dynamoose/dynamoose/tree/v3) | 3.0.0 | alpha | - [Documentation](https://dynamoose-git-v3-dynamoose.vercel.app/)<br>- [Pending Changelog](PENDING_CHANGELOG.md) |
