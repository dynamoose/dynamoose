...
| --- | --- | --- | --- |
| [`master`](https://github.com/dynamoose/dynamoose/tree/master) | 2.5.x |   | - [Documentation](https://dynamoose.now.sh/) |
| [`v2.5.0` (tag)](https://github.com/dynamoose/dynamoose/tree/v2.5.0) | 2.5.0 | latest | - [Documentation](https://dynamoosejs.com)
